    ...
    return(
        <View style={styles.container}>
            ...
            <View style={styles.desc}>
                <Text style={{fontWeight: "bold", fontSize: 17, paddingBottom: 5}}>Adam Fishball Noodle</Text>
                <Text style={{fontSize: 14, color: "#FA4A0C"}}>Adam Road Hawker Centre</Text>
                <Text style={{fontSize: 14, color: "#FA4A0C"}}>Floor 1, Stall 25</Text>
            </View>
